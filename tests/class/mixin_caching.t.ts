...
it('Repeating creation with different base class should call mixin functions', t => {
    let count1 = 0
    let count2 = 0
...
it('Should be possible to use `derive` over the non-mixin class, inheriting from mixin class', t => {
    //region setup
    let count1 = 0
    let count2 = 0
    let count3 = 0
...
it('Should be possible to use `derive` over the non-mixin class, inheriting from mixin class #2', t => {
    //region setup
    let count1 = 0
    let count2 = 0
    let count3 = 0
